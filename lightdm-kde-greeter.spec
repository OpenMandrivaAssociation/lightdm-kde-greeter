...
Source0: 	http://download.kde.org/unstable/lightdm-kde/src/lightdm-kde-%{version}.tar.bz2
...
%changelog
* Thu Sep 27 2012 Ural Mullabaev <ural.mullabaev@rosalab.ru> 0.3.0-1
- imported package lightdm-kde-greeter
